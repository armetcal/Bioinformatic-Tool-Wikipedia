...
-   **-o metaphlan_out/{}.txt**: Taxonomic annotations will be saved in this
    ...
    --nproc \$SLURM_CPUS_PER_TASK: use all the processing power available.\
    -t rel_ab_w_read_stats: Note that **no metagenomic annotation is perfectly
    analogous to 16S counts**. However, setting -t (analysis type) to
