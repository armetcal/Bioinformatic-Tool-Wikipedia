---
title: Trimming Adapters with BBMap
output: 
  html_document: 
    toc: true
    toc_depth: 3
...
BBMap contains a suite of tools. One of the tools, bbduk, can automatically find
and remove a [range of common adapter sequences and other similar
...
available in the list of built-in BBMap adapters. When running the tool, we can
