...
bbduk, can quality trim reads AND automatically find and remove a [range of
common adapter sequences and other similar
...
bbduk.sh \
 ...
 ftm=5 tpe tbo qtrim=rl trimq=25 maq=25 minlen=50 ref=adapters,phix \
